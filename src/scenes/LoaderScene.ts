...
class LoaderScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('player', '/assets/Necromancer/Idle/spr_NecromancerIdle_strip50.png', { frameWidth: 1000/50, frameHeight: 96 });
    this.load.spritesheet('death', '/assets/Necromancer/Death/spr_NecromancerDeath_strip52.png', { frameWidth: 1000/52, frameHeight: 96 });  
